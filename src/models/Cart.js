...
const cartSchema = new Schema({
  ...
  items: [{
    ...
    price: { type: Number, required: true, max: 1000000, min: 0 },
    productId: { type: Schema.Types.ObjectId, required: true },
    productQty: { type: Number, required: true, max: 100000, min: 0 },
    productSlug: { type: String, maxlength: 100 },
    total: { type: Number, max: 100000000000, min: 0 }
  }],
  quantity: { type: Number, max: 100000000000, min: 0 },
  subTotal: { type: Number, max: 100000000000, min: 0 },
